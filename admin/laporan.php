            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        $ix++;
                            if($row['keputusan'] == $diterima) $badge = 'success';
                            if($row['keputusan'] == $evaluasi) $badge = 'warning';
                            if($row['keputusan'] == $ditolak) $badge = 'danger';
                        ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <span class="badge bg-<?= $badge?>"><?= $row['keputusan']?></span>
                            </td>
