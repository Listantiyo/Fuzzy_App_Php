    ...
    <form id="skckForm" method="POST" action="user/simpan-pengajuan.php" enctype="multipart/form-data" novalidate>
      ...
      <ul class="nav nav-tabs mb-4" id="formTabs" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="step1-tab" data-bs-toggle="tab" data-bs-target="#step1" type="button" role="tab" aria-controls="step1" aria-selected="true">1. Jenis Pendaftaran</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="step2-tab" data-bs-toggle="tab" data-bs-target="#step2" type="button" role="tab" aria-controls="step2" aria-selected="false">2. Jenis Keperluan</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="step3-tab" data-bs-toggle="tab" data-bs-target="#step3" type="button" role="tab" aria-controls="step3" aria-selected="false">3. Data Pribadi</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="step4-tab" data-bs-toggle="tab" data-bs-target="#step4" type="button" role="tab" aria-controls="step4" aria-selected="false">4. Hubungan Keluarga</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="step5-tab" data-bs-toggle="tab" data-bs-target="#step5" type="button" role="tab" aria-controls="step5" aria-selected="false">5. Riwayat Pendidikan</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="step6-tab" data-bs-toggle="tab" data-bs-target="#step6" type="button" role="tab" aria-controls="step6" aria-selected="false">6. Perkara Pidana</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="step7-tab" data-bs-toggle="tab" data-bs-target="#step7" type="button" role="tab" aria-controls="step7" aria-selected="false">7. Ciri Fisik</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="step8-tab" data-bs-toggle="tab" data-bs-target="#step8" type="button" role="tab" aria-controls="step8" aria-selected="false">8. Lampiran</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="step9-tab" data-bs-toggle="tab" data-bs-target="#step9" type="button" role="tab" aria-controls="step9" aria-selected="false">9. Keterangan</button>
        </li>
      </ul>
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane fade" id="step2" role="tabpanel" aria-labelledby="step2-tab">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="detailKeperluan" name="detailKeperluan" placeholder="Masukkan detail keperluan" required />
        ...
        <div class="tab-pane fade" id="step4" role="tabpanel" aria-labelledby="step4-tab">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-4">
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="serumahAyah" id="serumahAyahYa" value="Ya" required />
                <label class="form-check-label" for="serumahAyahYa">Ya</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="serumahAyah" id="serumahAyahTidak" value="Tidak" required />
          ...
          <div class="row g-3">
            ...
            <div class="col-md-4">
              <label class="form-label required">Apakah Serumah</label><br/>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="serumahIbu" id="serumahIbuYa" value="Ya" required />
                <label class="form-check-label" for="serumahIbuYa">Ya</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="serumahIbu" id="serumahIbuTidak" value="Tidak" required />
        ...
        <div class="tab-pane fade" id="step5" role="tabpanel" aria-labelledby="step5-tab">
          ...
          <div class="mb-3">
            ...
            <input type="number" min="1900" max="2099" step="1" class="form-control" id="tahunLulus" name="tahunLulus" required />
        ...
        <div class="tab-pane fade" id="step7" role="tabpanel" aria-labelledby="step7-tab">
          ...
          <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="rumusSidikJari" id="rumusPunya" value="Ya" required />
              <label class="form-check-label" for="rumusPunya">Punya</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="rumusSidikJari" id="rumusTidakPunya" value="Tidak" required />
        ...
        <div class="tab-pane fade" id="step8" role="tabpanel" aria-labelledby="step8-tab">
          ...
          <div class="mb-3">
            ...
            <input type="file" class="form-control" id="fotoAkteIjazah" name="fotoAkteIjazah" accept="image/*" required />
        ...
        <div class="tab-pane fade" id="step9" role="tabpanel" aria-labelledby="step9-tab">
          <div class="mb-3 form-check form-switch">
            ...
            <label class="form-check-label" for="riwayatPekerjaan">Riwayat pekerjaan/negara yang pernah dikunjungi</label>
          </div>
          <div class="mb-3">
            <label for="riwayatPekerjaanAtauNegara" class="form-label">Riwayat pekerjaan/negara</label>
            <textarea class="form-control" id="riwayatPekerjaanAtauNegara" name="riwayatPekerjaanAtauNegara" rows="3"></textarea>
          </div>
          <div class="mb-3">
